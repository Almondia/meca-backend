...
public interface CardHistoryQueryDslRepository {
	...
	CursorPage<CardHistoryDto> findCardHistoriesByCardId(@NonNull Id cardId, int pageSize,
		Id lastCardHistoryId);

	CursorPage<CardHistoryDto> findCardHistoriesByCategoryId(@NonNull Id categoryId, int pageSize,
		Id lastCardHistoryId);

	CursorPage<CardHistoryDto> findCardHistoriesBySolvedMemberId(@NonNull Id solvedMemberId, int pageSize,
		Id lastCardHistoryId);
}
